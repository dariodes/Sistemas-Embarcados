...
while True:
    ...
    subprocess.call("curl -k --data \"entry.859460154="+str(int(data[2:8].decode("utf-8"), 16))+"\" https://docs.google.com/forms/d/1tfhcdKmafJVPrrW994O3eSQbdox4bUbeljjHI3thFUg/formResponse > log_out.txt", shell = True)
    # camera.start_preview()
    # sleep(5)
    # camera.capture('image.jpg')
    # camera.stop_preview()
    # subprocess.call("gdrive upload -p 1MmsFA-qAY-Ff6pUxvZ7xo9m2IK7E7oUH image.jpg", shell = True)
